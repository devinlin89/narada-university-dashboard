...
**Devin Lin** - Lead Developer (Pandas data processing pipeline, dashboard design and development, data visualization, and project maintenance)

**Therius Aaron Chen** - Dashboard Developer (Streamlit frontend, map visualizations, and major-specific features)
